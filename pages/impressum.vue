<template>
    <div>
        ...
        <div class="text-4xl">Impressum</div>

        <div class="text-lg">
            <div class="my-4">
                <div class="text-2xl">Angaben gemäß §5 TMG</div>
            ...
            <div class="my-4">
                ...
                Telefon: 025909400811<br>
                E-Mail: linus@tebbe.dev
            </div>

            <div class="my-4">
                <div class="text-2xl">Umsatzsteuer-ID</div>
                UStID. gemäß §27a UStG.: DE326934606
            </div>

            <div class="my-4">
                <div class="text-2xl">Streitschlichtung</div>
            ...
            <div class="my-4">
                <div class="text-2xl">Haftung für Inhalte</div>
            ...
            <div class="my-4">
                <div class="text-2xl">Haftung für Links</div>
            ...
            <div class="my-4">
                <div class="text-2xl">Urheberrecht</div>
        ...
        <div class="text-gray-600 -mt-4">Quelle: <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer">eRecht24</a></div>
        </div>
    </div>
</template>